      ...
      <div className="container-fluid p-5 border border-warning rounded" style={{
        ...
        <div className="service-content bg-white bg-opacity-75 p-5 border border-warning rounded text-center">
          <section className="service-0">
            ...
            <div className="embed-responsive embed-responsive-16by9 embed-responsive-lg-4by3 embed-responsive-md-4by3 mb-4">
              <iframe
                className="embed-responsive-item border border-warning"
          ...
          <div className="service1-2 d-flex flex-wrap justify-content-center mb-5">
            <h1 className="pt-3 text-start">El proceso</h1>
            ...
            <section className="service-2 d-flex flex-wrap justify-content-center">
              <img
                className="border border-warning rounded mb-3 me-3 w-25"
                src={rickyMeathook1}
          ...
          <section className="service-3">
            <div className="container">
              ...
              <p className="text pb-3">Te presento a Ricky, uno de mis primeros alumnos y de los <strong>más ambiciosos</strong>. Cuando empezamos se propuso lograr el push up en vertical, dominadas a un brazo y mejorar la fuerza de piernas para saltar. Iba a hacer todo lo necesario para <strong>lograrlo</strong>... y llegó a eso y más.</p>
              <div className="embed-responsive embed-responsive-16by9 embed-responsive-lg-4by3 embed-responsive-md-4by3 mb-4">
                <iframe className="embed-responsive-item border border-warning" src="https://www.youtube.com/embed/Z4uBn9YliZ4" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
              </div>
              <p className="text pb-3 pt-3">Elaboramos diferentes estrategias de trabajo para ir sorteando todas las dificultades que se nos presentaban y el video es el resultado de un proceso de 3 años en el que pudimos entrenar de forma <strong>consistente</strong>, avanzando de forma <strong>paciente</strong> y lo más importante: <strong>sin lesiones</strong> durante todo ese período. Hoy en día seguimos trabajando juntos con nuevos proyectos.</p>
            </div>
          </section>
