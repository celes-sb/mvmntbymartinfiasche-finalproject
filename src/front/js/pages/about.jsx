    ...
    <>
      <section className="about-us container-fluid">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12 col-12 img-container d-flex align-items-center">
              <img
                src={martin2}
