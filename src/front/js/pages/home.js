          ...
          <div className="container">
            <div className="hero-content">
              <div className="hero-content-text">
                <h1>
                  Entrena con MVMNT <br />
                  en <span>cualquier lugar</span> <br /> donde estés
                </h1>
                <h3>
                  Todos nuestros entrenamientos están diseñados para llevarte a
                  tu mejor condición física. Combinamos diferentes disciplinas
                  de entrenamiento como calistenia, weightlifting y movimiento.
                </h3>
