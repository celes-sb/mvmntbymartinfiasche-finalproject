    ...
    return (<>
        <div className="backofficeMedidas">
            ...
            <div className="form-floating">
                <textarea className="form-control" placeholder="Leave a comment here" value={dataUser.three_months_goal} id="floatingTextarea1" style={{ height: "100px" }} disabled></textarea>
                <label for="floatingTextarea1">Comentarios</label>
            </div>
            <h4 className="mt-2">Objetivos a 6 meses</h4>
            <div className="form-floating">
                <textarea className="form-control" placeholder="Leave a comment here" value={dataUser.six_months_goal} id="floatingTextarea2" style={{ height: "100px" }} disabled></textarea>
                <label for="floatingTextarea2">Comentarios</label>
            </div>
            <h4 className="mt-2">Objetivos a 12 meses</h4>
            <div className="form-floating">
                <textarea className="form-control" placeholder="Leave a comment here" value={dataUser.twelve_months_goal} id="floatingTextarea3" style={{ height: "100px" }} disabled></textarea>
